        ...
        <div className='intro-container'>
            <div className='page-intro'>
                <div className='text-box text-project'>
                    <div id='box2'>
                        <h2>Some projects I've worked on either solo or as part of a group:</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className='project-card' key={project.id}>
                    ...
                    <div className='project-links'>
                        <div className='project-url'>
                            ...
                            <a href={ project.url } target='_blank' rel='noopener noreferrer' aria-label='link to Project Deployment' className='url'>View</a>
                        </div>
                        <div className='project-github'>
                            <img src={gitIcon} alt='GitHub Icon' className='icon'/>
                            <a href={ project.github } target='_blank' rel='noopener noreferrer' aria-label='link to GitHub Repository' className='github'>GitHub</a>
                        </div>
                    </div>
                </div>
            })}
