        ...
        <div className='homebase-proper'>
            ...
            <div className='text-box homebase-box'>
                ...
                <div className='content'>
                    <p>After years of working as a freelance audio engineer, I wanted to take my experiences working with music and music technology to a new level.</p>
                    <p>At the end of 2022, I enrolled in a 6-month full-stack web development bootcamp in order to add another skillset which could benefit my love for music.</p>
                    <p>From no prior experience coding, I can now say that this site has built entirely with the React JavaScript library thanks to the bootcamp!</p>
                </div>
            </div>
        </div>
